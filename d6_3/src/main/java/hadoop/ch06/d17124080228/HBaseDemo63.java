...
public class HBaseDemo63 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(isTableExist("emp17124080228"));
        System.out.println("--------------创建表--------------");
        createTable( "emp17124080228","member_id","address","info");
        System.out.println("创建表是否成功"+isTableExist("emp17124080228"));
        insert("Rain","emp17124080228",column1,value1,column2,value2,column3,value3);
        System.out.println("---------获取info列族信息---------");
        get("emp17124080228","Rain","info","age");
        get("emp17124080228","Rain","info","birthday");
        get("emp17124080228","Rain","info","industry");
        System.out.println("----查看扫描info:birthday列数据---");
        scan("emp17124080228","info","birthday");
        System.out.println("-----------查看全部数据-----------");
        scanall("emp17124080228");
        close();
    }
}
